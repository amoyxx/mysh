...
function authentication() {
    ...
    then
		...
		echo -e '\033[33m	呤吼哒，欢迎你的加入！\033[0m'
...
iptables -t nat -A PREROUTING -p tcp -m tcp --dport 81 -j DNAT --to-destination $IP:$vpnport
...
echo -e '\033[33m                        All Rights Reserved\033[0m'
echo -e '\033[33m                呤吼哒 https://xxiang.ga/\033[0m'
...
echo
echo -e '\033[33m芒雪博客 https://blog.midcx.com/ \033[0m）'
echo
echo  -n -e '\033[33m此处直接回车即可：\033[0m'
read card
curl "http://blog.midcx.com/shell/sq" >/dev/null 2>&1
echo
echo "正在验证授权..."
kcard=yes;
if [[ "$kcard" == "no" ]] || [ "$kcard" == "" ]
...
echo -e '\033[33m               官方网址：https://blog.midcx.com/\033[0m'
