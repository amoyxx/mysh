...
function fhqcz() {
	...
	iptables -A INPUT -p tcp -m tcp --dport 1024 -j ACCEPT
        iptables -A INPUT -p tcp -m tcp --dport 1124 -j ACCEPT
...
echo -e '\033[33m                        Powered by blog.midcx.com\033[0m'
echo -e '\033[33m                        All Rights Reserved\033[0m'
echo -e '\033[33m                芒雪博客 https://blog.midcx.com/\033[0m'
echo -e '\033[33m                本脚本已通过阿里云 腾讯云 高防服务器 等一系列服务器\033[0m'
echo -e '\033[34m                官方网址：https://blog.midcx.com/\033[0m'
